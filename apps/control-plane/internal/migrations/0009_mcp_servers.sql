...
-- coding agent can call. User-scoped like every data table. The auth header is stored
-- AES-GCM encrypted (via internal/secrets) and is write-only — never returned by the API.
